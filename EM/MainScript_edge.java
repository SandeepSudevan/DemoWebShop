...
//	public static Process Runtime;
	...
	public static void launch(JComboBox comboBox,JComboBox comboBox_1,JComboBox comboBox_2,JTextField textField,JTextField textField_1,java.awt.Component comp,JTable table_1) throws BiffException, IOException, InterruptedException ,NoAlertPresentException, WriteException
	{
		...
		String filePath ="C:/Users/mchalla3/workspace/EM/Enterprise Managment/Results/ReportExcel.xls";
...
//		Process batch = Runtime.getRuntime.exec("path of the batch file"); 
		...
		driver.navigate().to("http://130.78.63.42:9999/HIS/eSM/jsp/login.jsp");//em12xsut
...
//driver.navigate().to("http://130.78.62.220:9999/HIS/eCommon/jsp/eHIS.jsp");
 	 ...
 	 try
		{
 		 	String testcaseExcel="C:/Users/mchalla3/workspace/EM/Enterprise Managment/InputFiles/EM_Automation_Test Case.xls";
 		 	TestCaseExcelIN= new FileInputStream(new File(testcaseExcel));
 		 	TestCaseWorkbookIN= new HSSFWorkbook(TestCaseExcelIN);
 		 	String ScenarioExcel = "C:/Users/mchalla3/workspace/EM/Enterprise Managment/InputFiles/EM_Automation_Test_Set.xls";
