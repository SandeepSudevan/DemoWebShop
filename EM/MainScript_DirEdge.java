...
public class MainScript_DirEdge{
...
//     System.setProperty("webdriver.edge.driver", "C:/eclipse-jee-neon-3-win32-x86_64/eclipse/msedgedriver.exe");
		System.setProperty("webdriver.edge.driver", "C:/Users/mchalla3/eclipse/msedgedriver.exe");	
...
//		driver = new InternetExplorerDriver(ieOptions);
		...
		/*
		 * driver.navigate().to("http://130.78.63.42:9999/HIS/eSM/jsp/login.jsp");//
		 * em12xsut driver.findElement(By.name("name")).sendKeys("NOPPADOLTH");
		 * driver.findElement(By.name("password")).sendKeys("SIHMIS"); WebElement
...
//driver.navigate().to(" http://130.78.94.106:8989/HIS/eSM/jsp/login.jsp");
