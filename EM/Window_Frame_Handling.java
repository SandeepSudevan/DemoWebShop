	...
	public static String framehandle1(String framename,WebDriver driver,String Parameter1) throws InterruptedException
	{
		...
		case "RIAuthorizeQueryResultFrame1":
		 ...
		 case "codedesc2":
				...
				driver.switchTo().frame("codedesc");
				break;
		 case "Pat_Search_Tabs_Frame1":
			   driver.switchTo().frame("dialog-body");
			   driver.switchTo().frame("Pat_Search_Tabs_Frame");
			 break;
		 case "frame02":
			 	driver.switchTo().frame("content");
			 	driver.switchTo().frame("f_query_add_mod");
		 ...
		 case "result7":
			 	...
			 	driver.switchTo().frame("result");
			 	break;
		 case "f_query_add_mod8":
			 	driver.switchTo().frame("content");
			 	driver.switchTo().frame("dialog-body");
			 	driver.switchTo().frame("f_query_add_mod");
			 	break;
		 case "criteria_frame3":
			 	driver.switchTo().frame("content");
			 	driver.switchTo().frame("dialog-body");
			 	driver.switchTo().frame("criteria_frame");
			 	break;
		 ...
		 case "patinsframe1":
			 	driver.switchTo().frame("content");
			 	driver.switchTo().frame("dialog-body");
			 	driver.switchTo().frame("patinsframe");
			 	break;
		 case "patinsbuttonframe1":
			 	driver.switchTo().frame("content");
			 	driver.switchTo().frame("dialog-body");
			 	driver.switchTo().frame("patinsbuttonframe");
			 	break;
		 case "criteria_frame4":
			 	driver.switchTo().frame("dialog-body");
			 	driver.switchTo().frame("criteria_frame");
			 	break;
		 case "contents_frame1":
			 	driver.switchTo().frame("dialog-body");
			 	driver.switchTo().frame("contents_frame");
			 	break;
			 case "buttons_frame1":
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("buttons_frame");
			 break;
			 case "amend_booking1":
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("amend_booking");
				 break;
			 case "f_query_add_mod10":
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("f_query_add_mod");
				 break;
			 case "patinsbuttonframe2":
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("patinsbuttonframe");
			 ...
			 case "tools1":
				 ...
				 driver.switchTo().frame("tools");
				 break;
			 case "f_query_add_mod_button2":
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("f_query_add_mod_button");
				 break;
			 case "f_query_add_mod_display2":
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("f_query_add_mod_display");
				 break;
			 case "Transfer_frame_display1":
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("Transfer_frame_display");
				 break;
			 case "Transfer_frame3":
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("Transfer_frame");
				 break;
			 case "Transfer_frame_buttons1":
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("Transfer_frame_buttons");
				 break;
			 case "f_query_add_mod11":
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("f_query_add_mod");
				 break;
			 case "newborndtls_frame3":
				 driver.switchTo().frame("content");
				 driver.switchTo().frame("f_query_add_mod");
				 driver.switchTo().frame("newborndtls_frame");
				 break;
			 case "BabyDetailsFrame1":
				 driver.switchTo().frame("content");
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("BabyDetailsFrame");
				 break;
			 case "PLINE2":
				 driver.switchTo().frame("content");
				 driver.switchTo().frame("dialog-body");
			 ...
			 case "PatientNotes1":
				 ...
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("PatientNotes");
				 break;
			 case "detail4":
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("detail");
			 ...
			 case "ConsButton1":
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("ConsButton");
				 break;
			 case "recordFrame3":
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("recordFrame");
			 ...
			 case "StatusButton1":
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("StatusButton");
				 break;
			 case "header_frame1":
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("header_frame");
			 ...
			 case "code_desc1":
				 driver.switchTo().frame("dialog-body");
				 driver.switchTo().frame("code_desc");
				 break;
			 case "report_buttons1":
				 driver.switchTo().frame("dialog-body");
			 ...
			 case "group_head4":
				 ...
				 driver.switchTo().frame("group_head");
				 break;
			 case "SalesReturnQueryHeader":
				 driver.switchTo().frame("content");
				 driver.switchTo().frame("f_query_add_mod");
				 driver.switchTo().frame("SalesReturnQueryHeader");
				 break;
			 case "SalesReturnQueryResult":
				 driver.switchTo().frame("content");
				 driver.switchTo().frame("f_query_add_mod");
				 driver.switchTo().frame("SalesReturnQueryResult");
				 break;
			 case "item_class_detail":
				 driver.switchTo().frame("content");
				 driver.switchTo().frame("f_query_add_mod");
				 driver.switchTo().frame("item_class_detail");
				 break;
			 case "item_detail":
				 driver.switchTo().frame("content");
				 driver.switchTo().frame("f_query_add_mod");
				 driver.switchTo().frame("item_detail");
				 break;
			 case "f_generatefilllist":
				 driver.switchTo().frame("content");
				 driver.switchTo().frame("f_generatefilllist");
				 break;
			 case "f_query_add_mod_result2":
					driver.switchTo().frame("content");
					driver.switchTo().frame("f_query_add_mod_result");
					break;
			 case "f_query_add_mod_result_det":
					driver.switchTo().frame("content");
					driver.switchTo().frame("f_query_add_mod_result_det");
					break;
			 case "buttonFrame11":
					driver.switchTo().frame("content");
					driver.switchTo().frame("buttonFrame1");
					break;
			 case "frameCondemnExpiredBatchesCriteria":
					driver.switchTo().frame("content");
					driver.switchTo().frame("f_query_add_mod");
					driver.switchTo().frame("frameCondemnExpiredBatchesCriteria");
					break;
			 case "frameExpiredBatchesList":
					driver.switchTo().frame("content");
					driver.switchTo().frame("f_query_add_mod");
					driver.switchTo().frame("frameExpiredBatchesList");
					break;
			 case "Visit Charge Details":
				    driver.switchTo().frame("dialog-body");
	                driver.switchTo().frame("dialog-body");
	                driver.switchTo().frame(driver.findElement(By.xpath("//iframe[contains(@src,'BLVisitChargeDet.jsp')]")));
	                break;
